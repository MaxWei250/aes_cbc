...
#include "fstream"
#include "zbase64.h"
//hack:今晚完成到了解密的测试，存在这样一个疑问点，解密输入的密文数组和预想的是转置的，这里需要解决并修复解密函数中的bug
int main()
{
	aes tool;
    ZBase64 base64;     aaaaaaaaaaaaaaaaaacccaa
    string plain_str = "aaaaaaaaaaaaaaaaaacccaa";
    int plainLen = 0;
    ...
    tool.initialization_vector("aaaaaaaaaaaaaaaa");
    //*密钥扩展
